...
<!-- Mirrored from gambolthemes.net/html-items/cursus_demo_f12/about_us by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 06:15:04 GMT -->
...
<head>
	...
	<!-- Favicon Icon -->
	<link rel="icon" type="image/png" href="<?php echo base_url(); ?>assets/imagesfav.png">

	<!-- Stylesheets -->
	<link href='http://fonts.googleapis.com/css?family=Roboto:400,700,500' rel='stylesheet'>
	<link href='<?php echo base_url(); ?>assets/vendor/unicons-2.0.1/css/unicons.css' rel='stylesheet'>
	<link href="<?php echo base_url(); ?>assets/css/vertical-responsive-menu.min.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets/css/style.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets/css/responsive.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets/css/night-mode.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets/css/vertical-responsive-menu1.min.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets/css/instructor-dashboard.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets/css/instructor-responsive.css" rel="stylesheet">
	...
	<link href="<?php echo base_url(); ?>assets/js/jquery-ui-timepicker.min.js" rel="stylesheet">
	...
	<!-- Map Box -->
	<script src='<?php echo base_url(); ?>../../../api.tiles.mapbox.com/mapbox-gl-js/v1.3.1/mapbox-gl.js'></script>
	<link href='<?php echo base_url(); ?>../../../api.tiles.mapbox.com/mapbox-gl-js/v1.3.1/mapbox-gl.css' rel='stylesheet' />
...
<body>
	...
	$query = "SELECT * FROM ADD_STREAMING where ID= " . $meetingid;
	...
	?>
		...
		<script type="text/javascript">
			alert("<?php echo $row['ID'] . ' ' . $row['Name'] . ' ' . $row['Password'] ?>");
		</script>
		...
		<div class="wrapper">
			<div class="sa4d25">
				<div class="container-fluid">
							...
							<div class="section3125">
								<div class="live1452">
									...
									<script type="text/javascript">
										...
										var meetConfig = {
											apiKey: "SzWA6p3jQdK8QkJ3mLZuFg",
											apiSecret: "4dbZKKtEDAHSvR8LlSUZBUU16DyseIuKilo2",
											meetingNumber: "<?php echo $row['ID'] ?>",
					...
					<script src="<?php echo base_url(); ?>assets/vendor/charts/Chart.min.js"></script>
					<script src="<?php echo base_url(); ?>assets/js/custom.js"></script>
					<script src="<?php echo base_url(); ?>assets/js/custom1.js"></script>

					<script src="<?php echo base_url(); ?>assets/js/test-timer.js"></script>
					...
					<script src="<?php echo base_url(); ?>assets/js/i18n/datepicker.en.js"></script>
					<script src="<?php echo base_url(); ?>assets/js/jquery.mCustomScrollbar.js"></script>

					<!-- Map Box JS -->
					<script src='<?php echo base_url(); ?>../../../unpkg.com/es6-promise%404.2.4/dist/es6-promise.auto.min.js'></script>
					<script src="<?php echo base_url(); ?>../../../unpkg.com/%40mapbox/mapbox-sdk%400.10.0/umd/mapbox-sdk.min.js"></script>
					<script>
...
<!-- Mirrored from gambolthemes.net/html-items/cursus_demo_f12/about_us by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 May 2020 06:15:06 GMT -->
