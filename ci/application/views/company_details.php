						...
						<div class="course_tabs">
							<nav>
								<div class="nav nav-tabs tab_crse  justify-content-center">
									...
									<a class="nav-item nav-link active" href="company_details">Company</a>
		...
		<div class="_215zd5">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="story125">
							<img src= "<?php echo base_url(); ?>assets/images/about/company.jpg" alt="">
						</div>
					</div>
				...
				<div class="branches_all">
					<div class="row">
						<div class="col-lg-4 col-md-4">						
							<div class="blogbg_1 mt-30">
								<a href="#" class="cpy_img">
									<img src= "<?php echo base_url(); ?>assets/images/about/company-1.jpg" alt="">
						...
						<div class="col-lg-4 col-md-4">						
							<div class="blogbg_1 mt-30">
								<a href="#" class="cpy_img">
									<img src= "<?php echo base_url(); ?>assets/images/about/company-2.jpg" alt="">
									<div class="course-overlay"></div>
								</a>
								<div class="cpy_content">
						...
						<div class="col-lg-4 col-md-4">						
							<div class="blogbg_1 mt-30">
								<a href="#" class="cpy_img">
									<img src= "<?php echo base_url(); ?>assets/images/about/company-3.jpg" alt="">
									<div class="course-overlay"></div>
								</a>
								<div class="cpy_content">
