						...
						<div class="section3125 rpt145">							
							<div class="row">						
								...
								<div class="col-lg-5">
									...
									<ul class="_bty149">
										<li><button class="studio-link-btn btn500" onclick="window.location.href = '#';">Edututs Studio</button></li>								
										...
										<div class="_htg452">
											...
											<div class="row">
												...
												<div class="col-lg-3 col-md-4">
													<div class="fcrse_1 mt-30">
														<div class="tutor_img">
															<a href="#"><img src= "<?php echo base_url(); ?>assets/images/left-imgs/img-2.jpg" alt=""></a>											
														</div>
														<div class="tutor_content_dt">
															<div class="tutor150">
												...
												<div class="col-lg-3 col-md-4">
													<div class="fcrse_1 mt-30">
														<div class="tutor_img">
															<a href="#"><img src= "<?php echo base_url(); ?>assets/images/left-imgs/img-3.jpg" alt=""></a>												
														</div>
														<div class="tutor_content_dt">
															<div class="tutor150">
