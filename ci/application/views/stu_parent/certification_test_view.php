								...
								<div class="ttl121">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item"><a href="certification_center">Certification Center</a></li>
											<li class="breadcrumb-item active" aria-current="page">WordPress Test View</li>
										</ol>
									</nav>
								</div>
							</div>
							<div class="titleright">						
								<a href="certification_center" class="blog_link"><i class="uil uil-angle-double-left"></i>Back to Certification Center</a>
							</div>
						</div>
						<div class="title126">	
									...
									<div class="ui form">
										<div class="grouped fields">										
											...
											<div class="field">
												<div class="ui radio checkbox">
													<input type="radio" name="example16" tabindex="0" class="hidden">
													<label>wp-settings</label>
												</div>
											</div>
											<div class="field">
												<div class="ui radio checkbox">
													<input type="radio" name="example16" tabindex="0" class="hidden">
													<label>wp-config</label>
												</div>
											</div>
											<div class="field fltr-radio">
												<div class="ui radio checkbox">
