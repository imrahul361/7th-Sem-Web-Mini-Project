				...
				<div class="row">
					...
					<div class="col-lg-9 col-md-7">
						<div class="blogbg_1 mt-50">
							<a href="blog_single_view" class="hf_img">
							...
							<div class="hs_content">
								...
								<a href="blog_single_view" class="crse14s title900">Blog Title Here</a>
								...
								<a href="blog_single_view" class="view-blog-link">Read More<i class="uil uil-arrow-right"></i></a>
							</div>
						</div>
